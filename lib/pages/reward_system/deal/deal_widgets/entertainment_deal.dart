...
class EntertainmentDeal extends StatefulWidget {
  const EntertainmentDeal({super.key});
  @override
  // ignore: library_private_types_in_public_api
  _EntertainmentDealState createState() => _EntertainmentDealState();
}

class _EntertainmentDealState extends State<EntertainmentDeal> {
  List<DocumentSnapshot> documents = [];
  bool isLoading = true;
  final String _case = 'entertainment';

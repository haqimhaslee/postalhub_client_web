...
class CommunityProgram extends StatefulWidget {
  const CommunityProgram({super.key});
  @override
  // ignore: library_private_types_in_public_api
  _CommunityProgramState createState() => _CommunityProgramState();
}

class _CommunityProgramState extends State<CommunityProgram> {
  List<DocumentSnapshot> documents = [];
  bool isLoading = true;
  final String _case = 'donation';

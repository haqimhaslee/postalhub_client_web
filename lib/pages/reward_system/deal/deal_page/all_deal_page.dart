...
class AllDealPage extends StatefulWidget {
  const AllDealPage({super.key});
  @override
  // ignore: library_private_types_in_public_api
  _AllDealPageState createState() => _AllDealPageState();
}

class _AllDealPageState extends State<AllDealPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text("All Deals")),
